...
Data for the charts comes from `.csv` files in `src/_data/`, which are generated by python scripts found in `scripts/`. The scripts fetch data from Google Analytics and Foresee.
