...
Baseline costs (pre-cloud) documented             |      | get more info from Duane
...
Application workload and compute / network requirements documented                 | Complete      |confirm
...
CSP accounts and sub accounts created                 |Complete       | (ask ketan "sub accounts"?)
