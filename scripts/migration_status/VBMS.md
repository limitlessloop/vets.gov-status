...
COMPLETED ALL OIT Intake Tasks                 |  Yellow  | No VIPR ID; should this be broken into smaller projects given size and entered in VIPR? Example: Phase 1: migrate data from Terramark using AWS Snowball.
