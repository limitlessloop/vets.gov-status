# Name: Memorial Benefits Management System (MBMS) Salesforce (MAG)
...
Planning checklist 100% completed                 | No      | ESCO CAS team developing
...
Provided inherited controls for CSP                     | Red    | Expecting to inherit infrasture controls from MAG or Salesforce; NCA dev team has requested this info from MS; (Dennis checking status on that)
...
Provisioning checklist 100% completed                 | No    | ECSO CAS to develop
COMPLETED ALL Provisioning Tasks                       | Green    | In progress
...
ECSSB decisions / tasks completed if applicable for connections              | Red      |  Blocker; require connections to VA BOS system; request was made months ago (Get date from Debbi)
