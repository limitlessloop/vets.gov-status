# Name: Financial Service Center (FSC) Hadoop (MAG)
...
------------                                      | -------- | ------------- 
Identify VA application owner                     |     | EPMO PM is Jonathan; need to identify the application owner
Initial cloud suitability 6 questions completed   |      |
ITOPs to review if "obsolete" system based on usage     |      | need to follow up w/ Chris / Jonthan
...
VIPR Epics completed                              |      | Not in VIPR
...
Task                                                          | Status   | Comments (only if yellow or red)
------------                                                  | -------- | -------------
VIPR ID created                                            |     | Not in VIPR; unsure if projects are all running tru VIPR
...
COMPLETED ALL OIT Intake Tasks                 |      | VIPR not filled out given timing of this project; not applicable at the time.
